...
# Set execute permissions for child scripts
chmod a+x ~/student/scripts/portfolio/Week2/passwordCheck.sh
chmod a+x ~/student/scripts/portfolio/Week2/foldermaker.sh
chmod a+x ~/student/scripts/portfolio/Week2/setPassword.sh
chmod a+x ~/student/scripts/portfolio/Week2/foldercopier.sh
chmod a+x ~/student/scripts/portfolio/Week3/calculator.sh
chmod a+x ~/student/scripts/portfolio/Week3/megafoldermaker.sh
chmod a+x ~/student/scripts/portfolio/Week3/filenames.sh
chmod a+x ~/student/scripts/portfolio/Week3/webDownloader.sh
...
################### Intial default password is 1234   ##############################################
...
~/student/scripts/portfolio/Week2/passwordCheck.sh || exit 1
...
# The Calculator case is used here
    "Calculator")
    ~/student/scripts/portfolio/Week3/calculator.sh
    # exit 0
    ;;

# The Create Weekly Folders case is used here
    "Create Weekly Folders")
    ~/student/scripts/portfolio/Week3/megafoldermaker.sh
    # exit 0
    ;;
...
# The Download A File case is used here
    "Download A File")
    ~/student/scripts/portfolio/Week3/webDownloader.sh
    # exit 0
    ;;
